...
public class PromptConstructionService {
        ...
        public static final String DDD_REFACTORING_PROMPT_TEMPLATE_PATH = "prompts/ddd-refactoring-prompt-template.md";
        public static final String DDD_REFACTORING_DOCUMENTATION_TEMPLATE_PATH = "prompts/ddd-refactoring-template.md";
